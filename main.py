...
class MainWindow(qtw.QWidget):
    ...
    def keypad(self):
        ...
        btn_equals = qtw.QPushButton("=", clicked = self.func_result)
        ...
        container.layout().addWidget(btn_6, 2, 3)
        container.layout().addWidget(btn_5, 3, 0)
        container.layout().addWidget(btn_4, 3, 1)
        container.layout().addWidget(btn_3, 3, 2)
        container.layout().addWidget(btn_2, 3, 3)
        container.layout().addWidget(btn_1, 4, 0)
        container.layout().addWidget(btn_0, 4, 1)
        container.layout().addWidget(btn_plus, 4, 2)
        container.layout().addWidget(btn_minus, 4, 3)
        container.layout().addWidget(btn_equals, 5, 0, 1, 2)
        container.layout().addWidget(btn_mult, 5, 2)
